<template>
	<div class="login-container">
        ...
        <transition name="fade"><password v-if="$route.query.action=='password'"></password></transition>
        <transition name="fade"><register v-if="$route.query.action=='register'"></register></transition>
