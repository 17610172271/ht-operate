            ...
            <div class="page-container">
                <div class="clear p-v-md">
                    <div class="statistics-datas-item pull-left m-r-lg">
                        <h5 class="p-o-md">代理商总数:</h5>
                        <div class="p-v-sm text-30 text-center">{{data.total_agent}} 个</div>
                    </div>
                    <div class="statistics-datas-item pull-left">
                        <h5 class="p-o-md">我的代理商:</h5>
                        <div class="p-v-sm text-30 text-center">{{data.my_agent}} 个</div>
                    </div>
                </div>
                <div class="m-t-md">
                    <h5 class="border-bottom text-bold text-xxlg p-v-sm">代理商统计</h5>
                    <div class="clear flex p-v-md">
                        ...
                        <div class="col-xs-12 col-lg-3 p-n" style="max-width: 320px;">
                            <div class="text-bold text-xxlg m-b-sm">各区域代理商排名</div>
                    ...
                    <h5 class="border-bottom text-bold text-xxlg p-v-sm m-t-md">代理商影院统计</h5>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            getData () {
                this.$http.post(api.statistics.agent, {
                    ...
                    if (res.data.code === 1) {
                        ...
                        let data = []
                        let column = []
                        this.data.region_agent.map(val => {
                            data.push(val.agent_num)
                            column.push(val.region_name)
                        })
                        // 处理代理商排名数据
                        this.rankList = this.data.region_agent.sort(sort('agent_num'))
                        // 处理代理商影院数据
                        let data1 = []
                        let column1 = []
                        this.data.region_cinema.map(val => {
                            data1.push(val.cinema_num)
