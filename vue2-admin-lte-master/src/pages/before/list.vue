                ...
                <div class="page-contaoner">
                    <div class="lk-table m-t-sm">
                        <ul class="table-thead clear">
                            ...
                            <li class="col-xs-1 p-n" v-show="selectVal.indexOf('宣传片名称')!=-1">宣传片名称</li>
                            <li class="col-xs-1 p-n" v-show="selectVal.indexOf('描述')!=-1">描述</li>
                        ...
                        <ul class="table-tbody clear" v-for="(item, index) in data.items">
                            ...
                            <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('宣传片名称')!=-1" :title="item.username">{{item.username}}</li>
                            <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('描述')!=-1" :title="item.realname">{{item.realname}}</li>
                            <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('创建时间')!=-1" :title="item.mobile">{{item.mobile}}</li>
                            ...
                            <li class="col-xs-1 p-n" v-show="selectVal.indexOf('操作')!=-1">
                                ...
                                <a href="javascript:;" v-if="getNavList['4080102']" title="详情" class="link" @click.stop="openDetail(item)">详情</a>
                    ...
                    <el-dialog
                        ...
                        <div v-loading="modalLoading">
                            <div class="clear m-b-sm">
                                <div class="col-xs-12 col-md-3 line-height-40 text-right min-width-105"><span class="text-red">*</span>宣传片名称:</div>
                                <div class="col-xs-12 col-md-7">
                                    <el-input placeholder="请输入宣传片名称" :disabled="type=== 'edit'"  :class="{'border-red': usernameError}" v-model="detailVal.username" @blur="validateUsername(detailVal.username)"></el-input>
                                    <p v-if="usernameError" class="text-red"><span class="fa fa-close m-r-xs"></span>请输入3-12位英文、数字、下划线组成的宣传片名称</p>
                                </div>
                            </div>
                            <div class="clear m-b-sm">
                                <div class="col-xs-12 col-md-3 line-height-40 text-right min-width-105"><span class="text-red">*</span>描述:</div>
                                <div class="col-xs-12 col-md-7">
                                    <el-input placeholder="请输入描述" :class="{'border-red': realnameError}" v-model="detailVal.realname" @blur="validaterealname(detailVal.realname)"></el-input>
                                    <p v-if="realnameError" class="text-red"><span class="fa fa-close m-r-xs"></span>请输入描述</p>
                                </div>
                            </div>
                    ...
                    <el-dialog
                        ...
                        <div v-loading="modalLoading">
                            <div class="clear m-b-sm">
                                <div class="col-xs-12 col-md-3 line-height-40 text-right min-width-105"><span class="text-red">*</span>宣传片名称:</div>
                                <div class="col-xs-12 col-md-7  text-left line-height-40">宣传片名称</div>
                            </div>
                            <div class="clear m-b-sm">
                                <div class="col-xs-12 col-md-3 line-height-40 text-right min-width-105"><span class="text-red">*</span>描述:</div>
                                <div class="col-xs-12 col-md-7  text-left line-height-40">描述</div>
                            </div>
                        </div>
                    </el-dialog>
                </div>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        data: () => ({
            ...
            loading: false,
            modalLoading: false,
            selectVal: ['序号', '宣传片名称', '描述', '创建时间', '操作'],
            showList: ['序号', '宣传片名称', '描述', '创建时间', '操作'],
