                ...
                <div class="page-contaoner">
                    <div class="lk-table m-t-sm">
                        ...
                        <ul class="table-tbody clear" v-for="(item, index) in data.items" @click="selectItem(item.id)">
                            ...
                            <li class="col-xs-1 p-n over-omit" v-show="selectVal.indexOf('状态名称')!=-1" :title="item.status_name">{{item.status_name}}</li>
                    ...
                    <el-dialog
                        ...
                        <div v-loading="modalLoading">
                            ...
                            <div class="clear bg-f9">
                                ...
                                <div class="col-xs-8 line-height-40">{{detailVal.agent_id}}</div>
                            </div>
                            <div class="clear">
                                <div class="col-xs-2 line-height-40 text-right">昵称:</div>
                                <div class="col-xs-8 line-height-40">{{detailVal.region_agent_id}}</div>
                            </div>
                            <div class="clear bg-f9">
                                <div class="col-xs-2 line-height-40 text-right">分组名称:</div>
                                <div class="col-xs-8 line-height-40">{{detailVal.cinema_id}}</div>
                            </div>
                        </div>
                    </el-dialog>
                    <el-dialog
                        ...
                        <div v-loading="modalLoading">
                            <div class="clear m-b-sm">
                                ...
                                <div class="col-xs-12 col-md-8">
                                    <el-select v-model="detailVal.agent_id" :class="{'border-red': agentError}" placeholder="请选择" @visible-change="selectOpen">
                                        <el-option
                            ...
                            <div class="clear m-b-sm">
                                ...
                                <div class="col-xs-12 col-md-8">
                                    <el-select v-model="detailVal.region_agent_id" :class="{'border-red': regionAgentError}" placeholder="请选择" @visible-change="selectOpen">
                                        <el-option
                                    ...
                                    <p v-if="regionAgentError" class="text-red"><span class="fa fa-close m-r-xs"></span>区域代理不能为空</p>
                                </div>
                            </div>
                            <div class="clear m-b-sm">
                            ...
                            <div class="clear m-b-sm">
                                <div class="col-xs-12 col-md-2 p-v-sm p-r-n text-right min-width-105"><span class="text-red">*</span>NAS名称码:</div>
                                <div class="col-xs-12 col-md-8">
                                    <el-input placeholder="请输入NAS名称码" :class="{'border-red': codeError}" v-model="detailVal.code" @blur="validateCode(detailVal.code)"></el-input>
                                    <p v-if="codeError" class="text-red"><span class="fa fa-close m-r-xs"></span>NAS名称码为最长4位数字</p>
                                </div>
                            </div>
                            <div class="clear m-b-sm">
                    ...
                    <el-dialog
                        ...
                        <div v-loading="modalLoading">
                            <div class="clear m-b-sm">
                                <div class="col-xs-12 col-md-4 p-v-sm p-r-n text-right">NAS:</div>
                                <div class="col-xs-12 col-md-8">
                            ...
                            <div class="clear m-b-sm">
                                <div class="col-xs-12 col-md-4 p-v-sm p-r-n text-right">播放器:</div>
                                <div class="col-xs-12 col-md-8">
                            ...
                            <div class="clear m-b-sm">
                                <div class="col-xs-12 col-md-4 p-v-sm p-r-n text-right">网关:</div>
                                <div class="col-xs-12 col-md-8">
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        data: () => ({
            ...
            loading: false,
            modalLoading: false,
            selectVal: ['checkbox', 'ID', '影片名称', 'NAS名称','状态名称','操作'],
            showList: ['checkbox', 'ID', '影片名称', 'NAS名称', '状态名称', '操作'],
        ...
        methods:{
            ...
            openDetail (item) {
                ...
                this.$http.get(api.naslist.detail, {
                    params: {
                        id: item.id
                    }
                }).then(res => {
            ...
            dailogSubmit () {
                this.validateAgent()
                this.validateRegionAgent()
                this.validateCinema()
                this.validateCode(this.detailVal.code)
                this.validateName(this.detailVal.name)
                console.log(1);
                if (this.nameError || this.codeError || this.agentError || this.regionAgentError || this.cinemaError) return
                console.log(2);
                if (this.type === 'edit') {
            ...
            validateRegionAgent () {
                this.regionAgentError = this.detailVal.region_agent_id ? false : true
            },
            validateCinema () {
        ...
        watch: {
            ...
            page (val) {
                this.$router.replace({name: 'sync_list', query: {page: val}})
                this.getList()
            },
            limit (val) {
                this.getList()
            ...
            'detailVal.region_agent_id' (val) {
                ...
                this.regionAgentError = val ? false : true
