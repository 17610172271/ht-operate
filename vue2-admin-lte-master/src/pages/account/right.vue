            ...
            <div class="page-container">
                <div class="page-toolbar clear m-t-sm">
                    <div class="pull-left toolbar-candle clear">
                        <router-link title="添加" :to="{name: 'right_add'}"
                ...
                <div class="page-contaoner">
                    <div class="lk-table m-t-sm">
                        <ul class="table-thead clear">
                            <li class="col-xs-24 p-n">ID</li>
                            <li class="col-xs-1 p-n">角色</li>
                            <li class="col-xs-24 p-n">角色描述</li>
                            <li class="col-xs-1 p-n">操作</li>
                        </ul>
                        <ul class="table-tbody clear" v-for="(item, index) in data.items">
                            <li class="col-xs-24 p-n" :title="item.id">{{item.id}}</li>
                            <li class="col-xs-1 p-n over-omit" :title="item.name">{{item.name}}</li>
                            <li class="col-xs-24 p-n over-omit" :class="{'text-green': item.status==1, 'text-red': item.status==2}" :title="item.status_name">{{item.status_name}}</li>
                            <li class="col-xs-1 p-n">
                                <router-link :to="{name: 'right_edit', params: {id: item.id}}" title="编辑" :class="{'disabled': item.name == '超级管理员'}" class="link" @click.stop>编辑</router-link>
