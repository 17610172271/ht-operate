                ...
                <div class="page-contaoner">
                    ...
                    <el-dialog
                        ...
                        <div v-loading="modalLoading">
                            ...
                            <div class="clear bg-f9">
                                <div class="col-xs-2 line-height-40 text-right min-width-105">头像:</div>
                                <!--<div class="col-xs-8 line-height-40">{{detailVal.avatar}}</div>-->
                                <a :href="detailVal.avatar" target="_blank"><img :src="detailVal.avatar" style="max-width: 160px;"></a>
                            </div>
                            <div class="clear">
        ...
        methods: {
            ...
            getList () {
                ...
                this.$http.post(api.member.list, {
                    nickname: this.searchOptions[0].value,
                    mobile: this.searchOptions[1].value,
                    page: this.page,
                    limit: this.limit
                }).then(res => {
                    this.selectedGroup = []
...
//            },
            ...
            getDetail (item) {
                ...
                this.$http.get(api.member.detail, {
                    params: {
                        id: item.id
                    }
                }).then(res => {
        ...
        watch: {
            ...
            page (val) {
                this.$router.replace({name: 'vip_list', query: {page: val}})
                this.getList()
            },
            limit (val) {
                this.getList()
